...
- [x] `flutter create critical_alert`
- [x] Add all dependencies to `pubspec.yaml`
- [x] Set up Android `AndroidManifest.xml` permissions
- [x] Set up iOS `Info.plist` and entitlements stub
- [x] Initialize Hive with `ReminderAdapter`
- [x] Initialize `flutter_local_notifications` with channel config
- [x] Verify a test notification fires correctly on both platforms
...
_Generated for Prio v1.0 planning. Last updated: June 2026._
